...
## Architecturally significant requirements (ASRs) and utility tree (10%)
...
## Component and Connector View (20%)
...
## Code Quality and Architectural Technical Debt (25%)
Assess your project's code quality using automated tools like Pylint, FindBugs, CppLint, Sonarqube, CodeScene. The last two are more tricky to configure so start early. Write a report documenting what you have found, and any possible **architecture** technical debt the project might be facing. Finally, propose a design solution to the problem using your modeling skills and one of the styles we have discussed.
...
## Final Presentation and Report  (10%)
